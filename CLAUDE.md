...
- **Campo dentro de uma `Surface` é `variant="secondary"`** — card, modal, drawer,
  acordeão. É o que a documentação do HeroUI manda, e o primário tem o mesmo fundo
  do overlay: no modo escuro o campo some.
